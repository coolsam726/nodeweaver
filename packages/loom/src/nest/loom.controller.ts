...
async function shellContext(
  ...
  return {
    ...
    allCompaniesSelected:
      loom.tenancyEnabled && !currentCompanyId && loom.canViewAllCompanies,
    ...
    accountPath: loom.accountPath,
    changePasswordPath: loom.changePasswordPath,
    forgotPasswordPath: loom.forgotPasswordPath,
    resetPasswordPath: loom.resetPasswordPath,
    apiDocsPath: loom.apiDocsPath,
